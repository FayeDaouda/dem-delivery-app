...
extension PoiCategoryX on PoiCategory {
  String get label {
    switch (this) {
      case PoiCategory.quartier:
        return 'Quartier';
      case PoiCategory.hopital:
        return 'Hôpital';
      case PoiCategory.marche:
        return 'Marché';
      case PoiCategory.ecole:
        return 'École / Université';
      case PoiCategory.stationBus:
        return 'Gare / Transport';
      case PoiCategory.stationEssence:
  ...
  Color get color {
    switch (this) {
      case PoiCategory.quartier:
        return const ui.Color.fromARGB(255, 19, 60, 82); // bleu-ardoise sobre
      case PoiCategory.hopital:
        return const ui.Color.fromARGB(255, 19, 60, 82); // bleu marine (brand)
      case PoiCategory.marche:
        return const ui.Color.fromARGB(255, 19, 60, 82); // bleu foncé
      case PoiCategory.ecole:
        return const ui.Color.fromARGB(255, 19, 60, 82); // bleu moyen
      case PoiCategory.stationBus:
        return const ui.Color.fromARGB(255, 19, 60, 82); // bleu cobalt
      case PoiCategory.stationEssence:
        return const ui.Color.fromARGB(255, 19, 60, 82); // bleu indigo
    }
  }
...
const List<PoiPoint> dakarPois = [
  ...
  PoiPoint(
    ...
    name: 'Médina',
    category: PoiCategory.quartier,
    position: LatLng(14.6901, -17.4530),
  ),
  PoiPoint(
    id: 'q_grand_dakar',
    name: 'Grand Dakar',
    category: PoiCategory.quartier,
    position: LatLng(14.6792, -17.4508),
  ),
  PoiPoint(
    id: 'q_hlm',
    name: 'HLM',
    category: PoiCategory.quartier,
    position: LatLng(14.6843, -17.4519),
  ),
  PoiPoint(
    id: 'q_liberte',
    name: 'Liberté',
    category: PoiCategory.quartier,
    position: LatLng(14.7052, -17.4579),
  ),
  PoiPoint(
    id: 'q_sacre',
    name: 'Sacré-Cœur',
    category: PoiCategory.quartier,
    position: LatLng(14.7109, -17.4689),
  ),
  PoiPoint(
    id: 'q_almadies',
    name: 'Almadies',
    category: PoiCategory.quartier,
    position: LatLng(14.7295, -17.5160),
  ),
  PoiPoint(
    id: 'q_yoff',
    name: 'Yoff',
    category: PoiCategory.quartier,
    position: LatLng(14.7495, -17.4830),
  ),
  PoiPoint(
    id: 'q_ouakam',
    name: 'Ouakam',
    category: PoiCategory.quartier,
    position: LatLng(14.7211, -17.4889),
  ),
  PoiPoint(
    id: 'q_parcelles',
    name: 'Parcelles Assainies',
    category: PoiCategory.quartier,
    position: LatLng(14.7530, -17.4600),
  ),
  PoiPoint(
    id: 'q_colobane',
    name: 'Colobane',
    category: PoiCategory.quartier,
    position: LatLng(14.6866, -17.4591),
  ),
  PoiPoint(
    id: 'q_ngor',
    name: 'Ngor',
    category: PoiCategory.quartier,
    position: LatLng(14.7412, -17.5100),
  ),
  PoiPoint(
    id: 'q_pointE',
    name: 'Point E',
    category: PoiCategory.quartier,
    position: LatLng(14.6987, -17.4627),
  ),
  PoiPoint(
    id: 'q_fann',
    name: 'Fann',
    category: PoiCategory.quartier,
    position: LatLng(14.6948, -17.4554),
  ),
  PoiPoint(
    id: 'q_mermoz',
    name: 'Mermoz',
    category: PoiCategory.quartier,
    position: LatLng(14.7194, -17.4820),
  ),
  ...
  PoiPoint(
    ...
    category: PoiCategory.hopital,
    position: LatLng(14.6909, -17.4441),
  ),
  PoiPoint(
    id: 'h_dantec',
    name: 'Hôpital Le Dantec',
    category: PoiCategory.hopital,
    position: LatLng(14.6823, -17.4493),
  ),
  PoiPoint(
    id: 'h_fann',
    name: 'CHU Fann',
    category: PoiCategory.hopital,
    position: LatLng(14.6948, -17.4582),
  ),
  PoiPoint(
    id: 'h_abass',
    name: 'Hôpital Abass Ndao',
    category: PoiCategory.hopital,
    position: LatLng(14.6922, -17.4533),
  ),
  PoiPoint(
    id: 'h_grand',
    name: 'Hôpital Grand Yoff',
    category: PoiCategory.hopital,
    position: LatLng(14.7369, -17.4643),
  ),
  PoiPoint(
    id: 'h_enfant',
    name: 'Hôp. Albert Royer',
    category: PoiCategory.hopital,
    position: LatLng(14.6958, -17.4552),
  ),
  ...
  PoiPoint(
    id: 'm_sandaga',
    name: 'Marché Sandaga',
    category: PoiCategory.marche,
    position: LatLng(14.6917, -17.4411),
  ),
  PoiPoint(
    id: 'm_kermel',
    name: 'Marché Kermel',
    category: PoiCategory.marche,
    position: LatLng(14.6877, -17.4430),
  ),
  PoiPoint(
    id: 'm_tilene',
    name: 'Marché Tilène',
    category: PoiCategory.marche,
    position: LatLng(14.6876, -17.4549),
  ),
  PoiPoint(
    id: 'm_colobane',
    name: 'Marché Colobane',
    category: PoiCategory.marche,
    position: LatLng(14.6871, -17.4594),
  ),
  PoiPoint(
    id: 'm_hlm',
    name: 'Marché HLM',
    category: PoiCategory.marche,
    position: LatLng(14.6839, -17.4551),
  ),
  PoiPoint(
    id: 'm_castors',
    name: 'Marché des Castors',
    category: PoiCategory.marche,
    position: LatLng(14.7048, -17.4718),
  ),
  PoiPoint(
    id: 'm_guediawaye',
    name: 'Marché Guédiawaye',
    category: PoiCategory.marche,
    position: LatLng(14.7710, -17.4060),
  ),
  ...
  PoiPoint(
    id: 'e_ucad',
    name: 'UCAD',
    category: PoiCategory.ecole,
    position: LatLng(14.6928, -17.4573),
  ),
  PoiPoint(
    id: 'e_ism',
    name: 'ISM',
    category: PoiCategory.ecole,
    position: LatLng(14.6984, -17.4625),
  ),
  PoiPoint(
    id: 'e_esp',
    name: 'École Polytechnique',
    category: PoiCategory.ecole,
    position: LatLng(14.6910, -17.4575),
  ),
  PoiPoint(
    id: 'e_uts',
    name: 'Univ. Sine Saloum',
    category: PoiCategory.ecole,
    position: LatLng(14.7005, -17.4610),
  ),
  PoiPoint(
    id: 'e_cesi',
    name: 'CESAG',
    category: PoiCategory.ecole,
    position: LatLng(14.7145, -17.4671),
  ),

  // ── Gares / Transports ───────────────────────────────────────────────────────
  PoiPoint(
    id: 'g_pompiers',
    name: 'Gare des Pompiers',
    category: PoiCategory.stationBus,
    position: LatLng(14.6909, -17.4374),
  ),
  PoiPoint(
    id: 'g_ter_dakar',
    name: 'Gare TER Dakar',
    category: PoiCategory.stationBus,
    position: LatLng(14.6869, -17.4382),
  ),
  PoiPoint(
    id: 'g_ter_colobane',
    name: 'Gare TER Colobane',
    category: PoiCategory.stationBus,
    position: LatLng(14.6861, -17.4584),
  ),
  PoiPoint(
    id: 'g_ter_thiaroye',
    name: 'Gare TER Thiaroye',
    category: PoiCategory.stationBus,
    position: LatLng(14.7382, -17.3614),
  ),
  PoiPoint(
    id: 'g_ddd_plateau',
    name: 'DDD Plateau',
    category: PoiCategory.stationBus,
    position: LatLng(14.6918, -17.4465),
  ),
  PoiPoint(
    id: 'g_ddd_almadies',
    name: 'DDD Almadies',
    category: PoiCategory.stationBus,
    position: LatLng(14.7285, -17.5089),
  ),
  ...
  PoiPoint(
    id: 's_total_plateau',
    name: 'Total Plateau',
    category: PoiCategory.stationEssence,
    position: LatLng(14.6935, -17.4445),
  ),
  PoiPoint(
    id: 's_total_alm',
    name: 'Total Almadies',
    category: PoiCategory.stationEssence,
    position: LatLng(14.7228, -17.5019),
  ),
  PoiPoint(
    id: 's_oryx_medina',
    name: 'Oryx Médina',
    category: PoiCategory.stationEssence,
    position: LatLng(14.6887, -17.4528),
  ),
  PoiPoint(
    id: 's_shell_sacre',
    name: 'Shell Sacré-Cœur',
    category: PoiCategory.stationEssence,
    position: LatLng(14.7104, -17.4697),
  ),
];
...
Set<Marker> buildPoiMarkersForZoom(
  ...
  for (final poi in visible) {
    if (minDist > 0 &&
        accepted.any(
          (a) => _haversineMeters(poi.position, a.position) < minDist,
        )) {
      continue;
    }
    accepted.add(poi);
