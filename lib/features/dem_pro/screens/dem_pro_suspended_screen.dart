...
/// Même mécanique que ChefDeFlotteSuspendedScreen/DriverSuspendedScreen —
/// voir appStartupNotifier.homeForRole pour le rôle DEM_PRO, qui vérifie
/// désormais `isActive` (auparavant seul `proStatus` était vérifié, un
/// compte suspendu — isActive: false, proStatus inchangé — n'était donc
/// jamais redirigé ici).
class DemProSuspendedScreen extends StatefulWidget {
  const DemProSuspendedScreen({super.key});
  @override
  State<DemProSuspendedScreen> createState() => _State();
}

class _State extends State<DemProSuspendedScreen> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Votre espace commerçant DEM Pro est temporairement suspendu',
                                style: TextStyle(
                          ...
                          children: [
                            ...
                            if (motif == null && fix == null) ...[
                              _InfoCard(
                                ...
                                body:
                                    'Votre espace commerçant DEM Pro a été suspendu. Vous ne pouvez plus créer de commandes ni recevoir de demandes tant qu\'il n\'est pas réactivé.',
                              ),
                              const SizedBox(height: 16),
                            ],
