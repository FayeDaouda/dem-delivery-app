  ...
  Future<void> _generateInvoice() async {
    ...
    try {
      ...
      if (!await requireProPlan(
        context,
        plan: merchant['proPlan'] as String?,
        title: 'Facture réservée aux plans Pro',
        message:
            'Les factures professionnelles exportables sont réservées aux '
          ...
          children: [
            ...
            _Card(
              children: [
                ...
                if (demFee > 0)
                  _PriceRow(label: 'Frais DEM', value: formatFcfa(demFee)),
                const SizedBox(height: 8),
                Divider(color: AppColors.lightBorder, height: 1),
                const SizedBox(height: 8),
                Row(
            ...
            _Card(
              children: [
                ...
                if (deliveredAt != null)
                  _DetailRow(
                    label: 'Durée',
                    value: _duration(createdAt, deliveredAt),
                  ),
              ],
            ),
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/dem-pro/orders/create', extra: order),
