        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ── Indicateur d'étape ─────────────────────────────────────
              const _StepIndicator(currentStep: 2, totalSteps: 3, label: 'En attente'),
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(
                        ...
                        style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: Color(0xFF0F2942)),
                      ),
                ...
                child: const Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Color(0xFF0F2942)),
                    ),
                    SizedBox(height: 10),
...
class _StepIndicator extends StatelessWidget {
  ...
  final String label;
  const _StepIndicator({required this.currentStep, required this.totalSteps, required this.label});
    ...
    child: Row(mainAxisSize: MainAxisSize.min, children: [
      ...
      Text(label,
        style: const TextStyle(
          fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.primaryDark, letterSpacing: 0.3,
        )),
      const SizedBox(width: 8),
      Container(width: 1, height: 12, color: AppColors.primary.withValues(alpha: 0.35)),
      const SizedBox(width: 8),
