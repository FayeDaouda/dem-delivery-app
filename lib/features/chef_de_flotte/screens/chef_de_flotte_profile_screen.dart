        ...
        child: Column(
          ...
          children: [
            ...
            _SupportTile(
              ...
              onTap: () => _launch('tel:+221710064664'),
            ),
            ...
            _SupportTile(
              ...
              sub: 'support@dem.sn',
              onTap: () => _launch('mailto:support@dem.sn'),
            ),
            const SizedBox(height: 10),
            _SupportTile(
              ...
              label: 'WhatsApp',
              sub: '+221 71 006 46 64',
              onTap: () => _launch('https://wa.me/221710064664'),
            ),
          ],
        ),
      ),
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          '$fleetSize/$fleetMax',
                          style: TextStyle(
                            color: AppColors.primaryMid.withValues(alpha: 0.70),
                            fontSize: 12,
                ...
                if (companyName != null || ninea != null || rccm != null) ...[
                  ...
                  _InfoCard(
                    children: [
                      ...
                      if (companyName != null &&
                          (ninea != null || rccm != null))
                        const Divider(height: 16),
                      if (ninea != null)
                        _InfoRow(icon: Icons.tag, label: 'NINEA', value: ninea),
                      if (ninea != null && rccm != null)
                        const Divider(height: 16),
                      if (rccm != null)
                        _InfoRow(
                ...
                Row(
                  children: [
                    Expanded(
                      child: _DocThumb(url: cniRecto, label: 'CNI recto'),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: _DocThumb(url: cniVerso, label: 'CNI verso'),
                    ),
                  ],
                ),
                const SizedBox(height: 24),
