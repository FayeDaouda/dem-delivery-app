    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (mounted)
          setState(() {
            _user = data;
            _badgeData = data['clientBadgeData'] as Map<String, dynamic>?;
          });
      }
    } catch (_) {}
  }
  ...
  Future<void> _requestPhoneChange() async {
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'La demande sera validée par notre équipe sous 24–48h.',
    ...
    try {
      ...
      await ApiClient.dio.post(
        '/users/client/phone-change',
        data: {'newPhone': '+221$local'},
      );
      if (mounted)
        showDemToast(
          context,
          'Demande envoyée. Vous serez contacté sous 24–48h.',
        );
    } catch (e) {
      if (mounted) showDemToast(context, friendlyError(e), isError: true);
    } finally {
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Container(
        ...
        padding: EdgeInsets.fromLTRB(
          ...
          16,
          20,
          MediaQuery.of(ctx).viewPadding.bottom + 36,
        ),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            SupportContactTile(
              ...
              subtitle: AppConfig.supportPhone,
              onTap: () =>
                  _launch('https://wa.me/${AppConfig.supportWhatsapp}'),
            ),
          ],
        ),
      ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ReferralCard(
                      referralCode: _user?['referralCode'] as String?,
                    ),
                    const SizedBox(height: 20),
                    ...
                    _MenuItem(
                      ...
                      title: 'Mes tournées groupées',
                      onTap: () => context.push('/orders/batch/mine'),
                    ),
                    const SizedBox(height: 10),
                    _MenuItem(
    ...
    child: Column(
      children: [
        for (int i = 0; i < items.length; i++) ...[
          if (i > 0)
            const Divider(height: 1, indent: 52, color: AppColors.lightBorder),
          _MenuItem(
            icon: items[i].icon,
            title: items[i].title,
            onTap: items[i].onTap,
