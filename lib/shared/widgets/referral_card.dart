...
class ReferralCard extends StatelessWidget {
  ...
  // WhatsApp non installé (ou schéma bloqué par l'OS) → repli sur le menu
  // de partage natif plutôt qu'un échec silencieux (le tap ne faisait
  // auparavant rien de visible dans ce cas).
